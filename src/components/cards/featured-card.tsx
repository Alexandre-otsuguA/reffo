    ...
    <Link href={href}>
      ...
      >
        ...
        <div className="ps-4 md:ps-5 lg:ps-4 3xl:ps-6">
          ...
          <div className="uppercase text-xs xl:text-13px font-heading font-semibold tracking-[0.6px] flex items-center text-skin-base text-opacity-60 transition duration-200 ease-in-out group-hover:text-opacity-100">
            {t('text-learn-more')}
