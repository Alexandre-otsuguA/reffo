...
import {
  useSignUpMutation,
  SignUpInputType,
} from '@framework/supabase/auth/use-signup';
...
const SignUpForm: React.FC<SignUpFormProps> = ({
  ...
  function onSubmit({ email, password }: SignUpInputType) {
    signUp({
      email,
      password,
      remember_me,
    ...
    >
      ...
      <div className="flex bg-skin-fill mx-auto rounded-lg overflow-hidden w-full">
        <div className="md:w-[55%] xl:w-[60%] registration hidden md:block">
          <Image
            src="https://images.unsplash.com/photo-1593508512255-86ab42a8e620?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=878&q=80"
            alt="signup image"
            width={800}
            height={620}
            className="w-full"
              ...
              <div className="flex items-center justify-center">
                <div className="flex items-center flex-shrink-0">
                  <label className="switch relative inline-block w-10 cursor-pointer">
                    <Switch checked={remember_me} onChange={setRememberMe} />
                  </label>
