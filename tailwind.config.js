...
module.exports = {
  ...
  theme: {
    ...
    boxShadow: {
      ...
      cart: '0 3px 6px rgba(34, 34, 34, 0.12)',
      ...
      listProduct: '0 2px 4px rgba(34, 34, 34, .08)',
      navigationReverse: '0 -3px 6px rgba(34, 34, 34, 0.16)',
      header: '0 2px 3px rgba(34, 34, 34, 0.08)',
      subMenu: '1px 2px 3px rgba(34, 34, 34, 0.08)',
      bottomNavigation: '0 -2px 3px rgba(34, 34, 34, 0.06)',
      cookies: '0 -2px 3px rgba(34, 34, 34, 0.04)',
      contact: '0 1px 10px rgba(75, 90, 130, 0.1)',
      vendorCard: '0px 2px 3px rgba(34, 34, 34, 0.06)',
      vendorCardHover: '0px 1px 15px rgba(34, 34, 34, 0.06)',
      vendorSidebar:
